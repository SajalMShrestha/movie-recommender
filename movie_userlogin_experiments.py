...
if "favorite_movies" not in st.session_state:
    st.session_state.favorite_movies = user_data["favorites"] if user_data else []

if "recommendations" not in st.session_state:
    st.session_state.recommendations = user_data["recommendations"] if user_data else []
...
if st.button("🎬 Get Recommendations"):
    if len(st.session_state.favorite_movies) < 3:
        ...
        with st.spinner("Finding recommendations..."):
            ...
            st.session_state.recommendations = [title for title, _ in recs]
            save_user_data(user_email, st.session_state.favorite_movies, st.session_state.recommendations)
...
if st.button("🚪 Log Out"):
    for key in ["user", "email", "favorite_movies", "movie_input", "recommendations"]:
